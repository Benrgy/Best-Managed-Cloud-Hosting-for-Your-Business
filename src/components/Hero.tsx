      ...
      <div className="relative max-w-6xl mx-auto text-center">
        ...
        <div className="bg-white/70 backdrop-blur-sm rounded-lg p-6 max-w-2xl mx-auto">
          <div className="flex items-center justify-center mb-3">
            ...
            <span className="font-semibold text-gray-900">Trusted by Businesses Worldwide</span>
          </div>
          <p className="text-gray-700 italic mb-2">
            "Switched to Cloudways and our site speed improved 3x! Migration was seamless and support is excellent!"
          </p>
          <p className="text-gray-600 text-sm">- Sarah Chen, Tech Startup Founder</p>
        </div>
      </div>
    </section>
  );
